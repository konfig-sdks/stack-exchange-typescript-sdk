...
export const FavoriteApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getUserFavorites: async (site: string, order?: 'desc' | 'asc', max?: string, min?: string, sort?: 'activity' | 'creation' | 'votes' | 'added', fromdate?: number, todate?: number, pagesize?: number, page?: number, filter?: string, callback?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'site' is not null or undefined
            assertParamExists('getUserFavorites', 'site', site)
            const localVarPath = `/me/favorites`;
...
export const FavoriteApiFp = function(configuration?: Configuration) {
    ...
    return {
        /**
         * Returns the questions favorites by the user associated with the given access_token.   This method returns a list of questions. 
         * @param {FavoriteApiGetUserFavoritesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getUserFavorites(requestParameters: FavoriteApiGetUserFavoritesRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<QuestionsInner>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getUserFavorites(requestParameters.site, requestParameters.order, requestParameters.max, requestParameters.min, requestParameters.sort, requestParameters.fromdate, requestParameters.todate, requestParameters.pagesize, requestParameters.page, requestParameters.filter, requestParameters.callback, options);
...
export const FavoriteApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getUserFavorites(requestParameters: FavoriteApiGetUserFavoritesRequest, options?: AxiosRequestConfig): AxiosPromise<Array<QuestionsInner>> {
            return localVarFp.getUserFavorites(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for getUserFavorites operation in FavoriteApi.
 * @export
 * @interface FavoriteApiGetUserFavoritesRequest
 */
export type FavoriteApiGetUserFavoritesRequest = {
    ...
    * @type {string}
    * @memberof FavoriteApiGetUserFavorites
    */
...
/**
 * FavoriteApiGenerated - object-oriented interface
 * @export
 * @class FavoriteApiGenerated
 * @extends {BaseAPI}
 */
export class FavoriteApiGenerated extends BaseAPI {
    /**
     * Returns the questions favorites by the user associated with the given access_token.   This method returns a list of questions. 
     * @param {FavoriteApiGetUserFavoritesRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof FavoriteApiGenerated
     */
    public getUserFavorites(requestParameters: FavoriteApiGetUserFavoritesRequest, options?: AxiosRequestConfig) {
        return FavoriteApiFp(this.configuration).getUserFavorites(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
