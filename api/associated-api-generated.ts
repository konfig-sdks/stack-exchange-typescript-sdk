...
/**
 * AssociatedApi - axios parameter creator
 * @export
 */
export const AssociatedApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         */
        getUserAccounts: async (pagesize?: number, page?: number, filter?: string, callback?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/me/associated`;
...
/**
 * AssociatedApi - functional programming interface
 * @export
 */
export const AssociatedApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = AssociatedApiAxiosParamCreator(configuration)
    return {
        /**
         * Returns all of a user\'s associated accounts, given an access_token for them.   This method returns a list of network users. 
         * @param {AssociatedApiGetUserAccountsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getUserAccounts(requestParameters: AssociatedApiGetUserAccountsRequest = {}, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<NetworkUsersInner>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getUserAccounts(requestParameters.pagesize, requestParameters.page, requestParameters.filter, requestParameters.callback, options);
...
/**
 * AssociatedApi - factory interface
 * @export
 */
export const AssociatedApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = AssociatedApiFp(configuration)
    return {
        /**
         * Returns all of a user\'s associated accounts, given an access_token for them.   This method returns a list of network users. 
         * @param {AssociatedApiGetUserAccountsRequest} requestParameters Request parameters.
         ...
         * @throws {RequiredError}
         */
        getUserAccounts(requestParameters: AssociatedApiGetUserAccountsRequest = {}, options?: AxiosRequestConfig): AxiosPromise<Array<NetworkUsersInner>> {
            return localVarFp.getUserAccounts(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for getUserAccounts operation in AssociatedApi.
 * @export
 * @interface AssociatedApiGetUserAccountsRequest
 */
export type AssociatedApiGetUserAccountsRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof AssociatedApiGetUserAccounts
    */
...
/**
 * AssociatedApiGenerated - object-oriented interface
 * @export
 * @class AssociatedApiGenerated
 * @extends {BaseAPI}
 */
export class AssociatedApiGenerated extends BaseAPI {
    /**
     * Returns all of a user\'s associated accounts, given an access_token for them.   This method returns a list of network users. 
     * @param {AssociatedApiGetUserAccountsRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof AssociatedApiGenerated
     */
    public getUserAccounts(requestParameters: AssociatedApiGetUserAccountsRequest = {}, options?: AxiosRequestConfig) {
        return AssociatedApiFp(this.configuration).getUserAccounts(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
