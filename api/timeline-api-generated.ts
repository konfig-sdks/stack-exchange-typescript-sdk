...
export const TimelineApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getUserTimeline: async (site: string, fromdate?: number, todate?: number, pagesize?: number, page?: number, filter?: string, callback?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'site' is not null or undefined
            assertParamExists('getUserTimeline', 'site', site)
            const localVarPath = `/me/timeline`;
...
export const TimelineApiFp = function(configuration?: Configuration) {
    ...
    return {
        /**
         * Returns a subset of the actions the user identified by the passed access_token has taken on the site.   This method returns a list of user timeline objects. 
         * @param {TimelineApiGetUserTimelineRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getUserTimeline(requestParameters: TimelineApiGetUserTimelineRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<UserTimelineObjectsInner>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getUserTimeline(requestParameters.site, requestParameters.fromdate, requestParameters.todate, requestParameters.pagesize, requestParameters.page, requestParameters.filter, requestParameters.callback, options);
...
export const TimelineApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getUserTimeline(requestParameters: TimelineApiGetUserTimelineRequest, options?: AxiosRequestConfig): AxiosPromise<Array<UserTimelineObjectsInner>> {
            return localVarFp.getUserTimeline(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for getUserTimeline operation in TimelineApi.
 * @export
 * @interface TimelineApiGetUserTimelineRequest
 */
export type TimelineApiGetUserTimelineRequest = {
    ...
    * @type {string}
    * @memberof TimelineApiGetUserTimeline
    */
...
/**
 * TimelineApiGenerated - object-oriented interface
 * @export
 * @class TimelineApiGenerated
 * @extends {BaseAPI}
 */
export class TimelineApiGenerated extends BaseAPI {
    /**
     * Returns a subset of the actions the user identified by the passed access_token has taken on the site.   This method returns a list of user timeline objects. 
     * @param {TimelineApiGetUserTimelineRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof TimelineApiGenerated
     */
    public getUserTimeline(requestParameters: TimelineApiGetUserTimelineRequest, options?: AxiosRequestConfig) {
        return TimelineApiFp(this.configuration).getUserTimeline(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
