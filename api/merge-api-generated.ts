 ...
 * @export
 */
export const MergeApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         */
        getAccountMergeList: async (pagesize?: number, page?: number, filter?: string, callback?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/me/merges`;
...
export const MergeApiFp = function(configuration?: Configuration) {
    ...
    return {
        /**
         * Returns a record of merges that have occurred involving a user identified by an access_token.   This method allows you to take now invalid account ids and find what account they\'ve become, or take currently valid account ids and find which ids were equivalent in the past.   This is most useful when confirming that an account_id is in fact \"new\" to an application.   Account merges can happen for a wide range of reasons, applications should not make assumptions that merges have particular causes.   Note that accounts are managed at a network level, users on a site may be merged due to an account level merge but there is no guarantee that a merge has an effect on any particular site.   This method returns a list of account_merge. 
         * @param {MergeApiGetAccountMergeListRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getAccountMergeList(requestParameters: MergeApiGetAccountMergeListRequest = {}, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<AccountMergeInner>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAccountMergeList(requestParameters.pagesize, requestParameters.page, requestParameters.filter, requestParameters.callback, options);
 ...
 * @export
 */
export const MergeApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAccountMergeList(requestParameters: MergeApiGetAccountMergeListRequest = {}, options?: AxiosRequestConfig): AxiosPromise<Array<AccountMergeInner>> {
            return localVarFp.getAccountMergeList(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for getAccountMergeList operation in MergeApi.
 * @export
 * @interface MergeApiGetAccountMergeListRequest
 */
export type MergeApiGetAccountMergeListRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof MergeApiGetAccountMergeList
    */
...
/**
 * MergeApiGenerated - object-oriented interface
 * @export
 * @class MergeApiGenerated
 * @extends {BaseAPI}
 */
export class MergeApiGenerated extends BaseAPI {
    /**
     * Returns a record of merges that have occurred involving a user identified by an access_token.   This method allows you to take now invalid account ids and find what account they\'ve become, or take currently valid account ids and find which ids were equivalent in the past.   This is most useful when confirming that an account_id is in fact \"new\" to an application.   Account merges can happen for a wide range of reasons, applications should not make assumptions that merges have particular causes.   Note that accounts are managed at a network level, users on a site may be merged due to an account level merge but there is no guarantee that a merge has an effect on any particular site.   This method returns a list of account_merge. 
     * @param {MergeApiGetAccountMergeListRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof MergeApiGenerated
     */
    public getAccountMergeList(requestParameters: MergeApiGetAccountMergeListRequest = {}, options?: AxiosRequestConfig) {
        return MergeApiFp(this.configuration).getAccountMergeList(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
