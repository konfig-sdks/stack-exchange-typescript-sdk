...
/**
 * MentionApi - axios parameter creator
 * @export
 */
export const MentionApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         */
        userCommentsList: async (site: string, order?: 'desc' | 'asc', max?: string, min?: string, sort?: 'creation' | 'votes', fromdate?: number, todate?: number, pagesize?: number, page?: number, filter?: string, callback?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'site' is not null or undefined
            assertParamExists('userCommentsList', 'site', site)
            const localVarPath = `/me/mentioned`;
...
/**
 * MentionApi - functional programming interface
 * @export
 */
export const MentionApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = MentionApiAxiosParamCreator(configuration)
    return {
        /**
         * Returns the comments mentioning the user associated with the given access_token.   This method returns a list of comments. 
         * @param {MentionApiUserCommentsListRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async userCommentsList(requestParameters: MentionApiUserCommentsListRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<CommentsInner>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.userCommentsList(requestParameters.site, requestParameters.order, requestParameters.max, requestParameters.min, requestParameters.sort, requestParameters.fromdate, requestParameters.todate, requestParameters.pagesize, requestParameters.page, requestParameters.filter, requestParameters.callback, options);
...
/**
 * MentionApi - factory interface
 * @export
 */
export const MentionApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = MentionApiFp(configuration)
    return {
        /**
         * Returns the comments mentioning the user associated with the given access_token.   This method returns a list of comments. 
         * @param {MentionApiUserCommentsListRequest} requestParameters Request parameters.
         ...
         * @throws {RequiredError}
         */
        userCommentsList(requestParameters: MentionApiUserCommentsListRequest, options?: AxiosRequestConfig): AxiosPromise<Array<CommentsInner>> {
            return localVarFp.userCommentsList(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for userCommentsList operation in MentionApi.
 * @export
 * @interface MentionApiUserCommentsListRequest
 */
export type MentionApiUserCommentsListRequest = {
    ...
    * @type {string}
    * @memberof MentionApiUserCommentsList
    */
...
/**
 * MentionApiGenerated - object-oriented interface
 * @export
 * @class MentionApiGenerated
 * @extends {BaseAPI}
 */
export class MentionApiGenerated extends BaseAPI {
    /**
     * Returns the comments mentioning the user associated with the given access_token.   This method returns a list of comments. 
     * @param {MentionApiUserCommentsListRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof MentionApiGenerated
     */
    public userCommentsList(requestParameters: MentionApiUserCommentsListRequest, options?: AxiosRequestConfig) {
        return MentionApiFp(this.configuration).userCommentsList(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
