...
export const PrivilegeApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getEarnableList: async (site: string, pagesize?: number, page?: number, filter?: string, callback?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'site' is not null or undefined
            assertParamExists('getEarnableList', 'site', site)
            const localVarPath = `/privileges`;
         ...
         * @throws {RequiredError}
         */
        getUserPrivileges: async (site: string, pagesize?: number, page?: number, filter?: string, callback?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'site' is not null or undefined
            assertParamExists('getUserPrivileges', 'site', site)
            const localVarPath = `/me/privileges`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const PrivilegeApiFp = function(configuration?: Configuration) {
    ...
    return {
        /**
         * Returns the earnable privileges on a site.   Privileges define abilities a user can earn (via reputation) on any Stack Exchange site.   While fairly stable, over time they do change. New ones are introduced with new features, and the reputation requirements change as a site matures.   This method returns a list of privileges. 
         * @param {PrivilegeApiGetEarnableListRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getEarnableList(requestParameters: PrivilegeApiGetEarnableListRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<PrivilegesInner>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getEarnableList(requestParameters.site, requestParameters.pagesize, requestParameters.page, requestParameters.filter, requestParameters.callback, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Returns the privileges the user identified by access_token has.   This method returns a list of privileges. 
         * @param {PrivilegeApiGetUserPrivilegesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getUserPrivileges(requestParameters: PrivilegeApiGetUserPrivilegesRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<PrivilegesInner>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getUserPrivileges(requestParameters.site, requestParameters.pagesize, requestParameters.page, requestParameters.filter, requestParameters.callback, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const PrivilegeApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getEarnableList(requestParameters: PrivilegeApiGetEarnableListRequest, options?: AxiosRequestConfig): AxiosPromise<Array<PrivilegesInner>> {
            return localVarFp.getEarnableList(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns the privileges the user identified by access_token has.   This method returns a list of privileges. 
         * @param {PrivilegeApiGetUserPrivilegesRequest} requestParameters Request parameters.
         ...
         * @throws {RequiredError}
         */
        getUserPrivileges(requestParameters: PrivilegeApiGetUserPrivilegesRequest, options?: AxiosRequestConfig): AxiosPromise<Array<PrivilegesInner>> {
            return localVarFp.getUserPrivileges(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for getEarnableList operation in PrivilegeApi.
 * @export
 * @interface PrivilegeApiGetEarnableListRequest
 */
export type PrivilegeApiGetEarnableListRequest = {
    ...
    * @type {string}
    * @memberof PrivilegeApiGetEarnableList
    */
...
/**
 * Request parameters for getUserPrivileges operation in PrivilegeApi.
 * @export
 * @interface PrivilegeApiGetUserPrivilegesRequest
 */
export type PrivilegeApiGetUserPrivilegesRequest = {
    
    /**
    * Each of these methods operates on a single site at a time, identified by the site parameter. This parameter can be the full domain name (ie. \"stackoverflow.com\"), or a short form identified by api_site_parameter on the site object. 
    * @type {string}
    * @memberof PrivilegeApiGetUserPrivileges
    */
    readonly site: string
...
/**
 * PrivilegeApiGenerated - object-oriented interface
 * @export
 * @class PrivilegeApiGenerated
 * @extends {BaseAPI}
 */
export class PrivilegeApiGenerated extends BaseAPI {
    /**
     * Returns the earnable privileges on a site.   Privileges define abilities a user can earn (via reputation) on any Stack Exchange site.   While fairly stable, over time they do change. New ones are introduced with new features, and the reputation requirements change as a site matures.   This method returns a list of privileges. 
     * @param {PrivilegeApiGetEarnableListRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof PrivilegeApiGenerated
     */
    public getEarnableList(requestParameters: PrivilegeApiGetEarnableListRequest, options?: AxiosRequestConfig) {
        return PrivilegeApiFp(this.configuration).getEarnableList(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof PrivilegeApiGenerated
     */
    public getUserPrivileges(requestParameters: PrivilegeApiGetUserPrivilegesRequest, options?: AxiosRequestConfig) {
        return PrivilegeApiFp(this.configuration).getUserPrivileges(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
