...
// @ts-ignore
import { InboxItemsInnerSite } from '../models';
...
export const SiteApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        listSites: async (pagesize?: number, page?: number, filter?: string, callback?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const SiteApiFp = function(configuration?: Configuration) {
    ...
    return {
        /**
         * Returns all sites in the network.   This method allows for discovery of new sites, and changes to existing ones. Be aware that unlike normal API methods, this method should be fetched very infrequently, it is very unusual for these values to change more than once on any given day. It is suggested that you cache its return for at least one day, unless your app encounters evidence that it has changed (such as from the /info method).   The pagesize parameter for this method is unbounded, in acknowledgement that for many applications repeatedly fetching from /sites would complicate start-up tasks needlessly.   This method returns a list of sites. 
         * @param {SiteApiListSitesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async listSites(requestParameters: SiteApiListSitesRequest = {}, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<InboxItemsInnerSite>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listSites(requestParameters.pagesize, requestParameters.page, requestParameters.filter, requestParameters.callback, options);
...
export const SiteApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        listSites(requestParameters: SiteApiListSitesRequest = {}, options?: AxiosRequestConfig): AxiosPromise<Array<InboxItemsInnerSite>> {
            return localVarFp.listSites(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for listSites operation in SiteApi.
 * @export
 * @interface SiteApiListSitesRequest
 */
export type SiteApiListSitesRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof SiteApiListSites
    */
...
export class SiteApiGenerated extends BaseAPI {
     ...
     */
    public listSites(requestParameters: SiteApiListSitesRequest = {}, options?: AxiosRequestConfig) {
        return SiteApiFp(this.configuration).listSites(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
